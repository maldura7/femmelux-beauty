...
| Backend API | Render | api.femmelux.com / al-raud.onrender.com |
...
3. Note your Render URL (e.g., `https://al-raud.onrender.com`)
...
| Key | Value |
|-----|-------|
| `NEXT_PUBLIC_API_URL` | `https://al-raud.onrender.com/api` |
...
### Test Backend API
```bash
curl https://al-raud.onrender.com/api/health
```
...
| Variable | Description | Example |
|----------|-------------|---------|
| `NEXT_PUBLIC_API_URL` | Backend API URL with /api | `https://al-raud.onrender.com/api` |
...
Set up a monitor to ping: `https://al-raud.onrender.com/api/health`
